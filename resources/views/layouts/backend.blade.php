        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="{{ request()->is('pages/*') ? ' open' : '' }}">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-bulb"></i><span class="sidebar-mini-hide">Management</span></a>
                                <ul>
                                    <li>
                                        <a class="{{ request()->is('/users') ? ' active' : '' }}" href="/users">Users</a>
                                    </li>
                                    <li>
                                        <a class="{{ request()->is('/profile') ? ' active' : '' }}" href="/profile">Profiles</a>
                                    </li>
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    <!-- Left Section -->
                    <div class="content-header-section" style="display: none;">
                        <!-- Toggle Sidebar -->
                        <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
